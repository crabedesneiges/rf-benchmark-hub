...
#SBATCH --output=logs/rfbench_torchsig_probe_%j.out
#SBATCH --error=logs/rfbench_torchsig_probe_%j.err
#SBATCH --nodes=1
...
VENV="${RFBENCH_VENV_DETECTION:-$WORK/envs/rfbench-arm-detection}"
